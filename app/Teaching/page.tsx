  ...
  return (
    <div className="text-sm p-2">
        ...
        <p className="mb-4">
          ...
          I was selected to fill in by fellow T.A.'s after <a href="https://www.elizabethorrico.com/home" target="_blank" className="text-[color:var(--ss-accent)] underline hover:text-[color:var(--ss-accent-dark)]">
        ...
        <a
          ...
          className="text-[color:var(--ss-accent)] underline hover:text-[color:var(--ss-accent-dark)]"
          >
          10:00 AM Lecture
        </a>
        <a
